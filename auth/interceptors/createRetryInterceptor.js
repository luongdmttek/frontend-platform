...
const defaultGetBackoffMilliseconds = function (nthRetry) {
  let maximumBackoffMilliseconds = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 16000;
...
const createRetryInterceptor = function () {
